  ...
  return (
    <div className='terms-of-service'>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and Fitra LLC
        ("Company", “we”, “us”, or “our”), concerning your access to and use of
        the fitra.xyz website as well as any other media form, media channel,
        ...
        online marketplace for the following goods, products, and/or services:
        meal-plan and diet creation, other lifestyle and wellness coaching (the
        ...
        OFFERINGS AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms
        and conditions or documents that may be posted on the Site from time to
        ...
        change. It is your responsibility to periodically review these Terms of
        Use to stay informed of updates. You will be subject to, and will be
      ...
      <ul>
        ...
        <li>
          2. Make any unauthorized use of the Marketplace Offerings, including
        ...
        <li>
          14. Use the Marketplace Offerings as part of any effort to compete
      ...
      <p>
        ...
        the State of Illinois applicable to agreements made and to be entirely
        performed within the State of Illinois, without regard to its conflict
        of law principles.
      </p>
      ...
      <p>
        ...
        in Cook, Illinois. Except as otherwise provided herein, the Parties may
      ...
      <p>
        ...
        courts located in Cook, Illinois, and the Parties hereby consent to, and
      ...
      <p>
        ...
        BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING
        THE THREE (3) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR
        $1,000.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
