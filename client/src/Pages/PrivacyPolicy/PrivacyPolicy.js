...
const PrivacyPolicy = () => (
  <div className="privacy-policy">
    ...
    <p>
      Thank you for choosing to be part of our community at Fitra LLC, doing business as Fitra
      ("Fitra", "we", "us", "our"). We are committed to protecting your personal information and
    ...
    <p>
      When you visit our website https://fitr.xyz (the "Website"), and more generally, use any of
      our services (the "Services", which include the Website), we appreciate that you are trusting
      us with your personal information. We take your privacy very seriously. In this privacy
      notice, we seek to explain to you in the clearest way possible what information we collect,
      how we use it and what rights you have in relation to it. We hope you take some time to read
    ...
    <p>
      Personal Information Provided by You. We collect names; email addresses; usernames; contact or
    ...
    <p>
      ...
      their privacy notice link(s) here: https://www.paypal.com/us/webapps/mpp/ua/privacy-full.
    </p>
    <p>
    ...
    <p>
      ...
      This information is primarily needed to maintain the security and operation of our Website,
    ...
    <ul>
      <li>
        ...
        information our servers automatically collect when you access or use our Website and which
        we record in log files. Depending on how you interact with us, this log data may include
        your IP address, device information, browser type and settings and information about your
        activity in the Website (such as the date/time stamps associated with your usage, pages and
      ...
      <li>
        ...
        or other device you use to access the Website. Depending on the device used, this device
      ...
      <li>
        ...
        type and settings of the device you use to access the Website. For example, we may use GPS
        ...
        device. Note however, if you choose to opt out, you may not be able to use certain aspects
        of the Services.
      </li>
    </ul>
    ...
    <p>
      ...
      platforms, as well as from other third parties. This information includes mailing addresses,
      job titles, email addresses, phone numbers, intent data (or user behavior data), Internet
      ...
      information about you such as your name, email address, and gender. Any personal information
      that we collect from your social media account depends on your social media account's privacy
      settings.
    </p>
    ...
    <ul>
      <li>
        ...
        process for the performance of the contract. See the section below headed "HOW DO WE HANDLE
      ...
      <li>
        ...
        please contact us at fitraxyzhealth@gmail.com and be sure to include your name, testimonial
    ...
    <ul>
      ...
      <li>
        ...
        Website, which will enable them to collect data on our behalf about how you interact with
        our Website over time. This information may be used to, among other things, analyze and
        track data, determine the popularity of certain content, pages or features, and better
        understand online activity. Unless described in this notice, we do not share, sell, rent or
        trade any of your information with third parties for their promotional purposes. We have
        contracts in place with our data processors, which are designed to help safeguard your
        personal information. This means that they cannot do anything with your personal information
        unless we have instructed them to do it. They will also not share your personal information
        with any organization apart from us. They also commit to protect the data they hold on our
      ...
      <li>
        ...
        visit or use the Website. These companies may use information about your visits to our
      ...
      <li>
        ...
        contributions or other content to the Website) or otherwise interact with public areas of
        the Website, such personal information may be viewed by all users and may be publicly made
        available outside the Website in perpetuity. If you interact with other users of our Website
        and register for our Website through a social network (such as Facebook), your contacts on
        ...
        you within our Website, and view your profile.
      </li>
    </ul>
    ...
    <p>
      ...
      privacy notice or that are otherwise made clear to you on the relevant Website. Please note
    ...
    <p>
      Our servers are located in United States, Australia, Belgium, and Netherlands. If you are
      accessing our Website from outside United States, Australia, Belgium, and Netherlands, please
      ...
      "WILL YOUR INFORMATION BE SHARED WITH ANYONE?" above), in United States, and other countries.
    </p>
    <p>
      ...
      will however take all necessary measures to protect your personal information in accordance
    ...
    <p>
      ...
      require all recipients to protect all personal information that they process originating from
      the EEA in accordance with European data protection laws and regulations. Our Standard
    ...
    <p>
      ...
      share with third-party providers who advertise, but are not affiliated with, our Website.
    </p>
    <p>
      The Website may contain advertisements from third parties that are not affiliated with us and
      which may link to other websites, online services or mobile applications. We cannot guarantee
      the safety and privacy of data you provide to any third parties. Any data collected by third
      parties is not covered by this privacy notice. We are not responsible for the content or
      privacy and security practices and policies of any third parties, including other websites,
      services or applications that may be linked to or from the Website. You should review the
    ...
    <p>
      ...
      the Website, you represent that you are at least 18 or that you are the parent or guardian of
      ...
      please contact us at fitraxyzhealth@gmail.com.
    </p>
    <h3>12. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
    <p>
      <strong>In Short: </strong> In some regions, such as the European Economic Area, you have
    ...
    <p>
      ...
      fraud, troubleshoot problems, assist with any investigations, enforce our Terms of Use and/or
    ...
    <p>
      ...
      or services of our Website. To opt-out of interest-based advertising by advertisers on our
    ...
    <h4>14. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h4>
    <p>
    ...
    <p>
      ...
      Website, but please be aware that the data may not be completely or comprehensively removed
    ...
    <p>
      You may contact us by email at fitraxyzhealth@gmail.com, or by referring to the contact
    ...
    <p>
      Fitra LLC has disclosed the following categories of personal information to third parties for
    ...
    <ul>
      ...
      <li>
        Category B. Personal information, as defined in the California Customer Records law, such as
        your name, contact information, education, employment, employment history and financial
        information.
      </li>
      <li>
      ...
      <li>
        Category D. Commercial information, such as transaction information, purchase history,
        financial details and payment information.
      </li>
      <li>Category E. Biometric information, such as fingerprints and voiceprints.</li>
      <li>
        Category F. Internet or other electronic network activity information, such as browsing
        history, search history, online behavior, interest data, and interactions with our and other
        websites, applications, systems and advertisements.
      </li>
      <li>Category G. Geolocation data, such as device location.</li>
      <li>
        Category H. Audio, electronic, visual and similar information, such as images and audio,
        video or call recordings created in connection with our business activities.
      </li>
      <li>
        Category I. Professional or employment-related information, such as business contact details
        in order to provide you our services at a business level, job title as well as work history
      ...
      <li>
        Category K. Inferences drawn from any of the personal information listed above to create a
        profile or summary about, for example, an individual's preferences and characteristics.
      </li>
    </ul>
    <p>
    ...
    <p>
      ...
      require us to ask you to provide information so that we can match it with information you have
      previously provided us. For instance, depending on the type of request you submit, we may ask
      you to provide certain information so that we can match the information you provide with the
    ...
    <p>
      ...
      information from you for the purposes of verification. If, however, if we cannot verify your
    ...
    <p>
      To exercise these rights, you can contact us by email at fitraxyzhealth@gmail.com, or by
    ...
    <p>
      ...
      submit a request form by clicking here. We will respond to your request within 30 days. This
